...
This web application is designed to predict customer churn using machine learning & concepts of ANN. The app is built using Streamlit, a Python library for creating interactive web applications.
